        ...
        navItems: [
            { id: "home", to: '/', icon: 'material-symbols:home-outline', text: 'Home' },
            {
                id: "data", icon: 'material-symbols:analytics-outline', text: 'Data analytics', children: [
                    ...
                    { id: "chatToData", to: '/chat-to-data', icon: 'material-symbols:chat-outline', text: 'Chat to data' },
                ]
            },
            {
                id: "tools", icon: 'material-symbols:tools-wrench-outline', text: 'GenAI utils', children: [
                    { id: "newChat", to: '/chat', icon: 'material-symbols:edit-square-outline', text: 'New chat' },
                    { id: "prompt", to: '/prompt-engineering', icon: 'material-symbols:lightbulb-outline', text: 'Prompt scratchboard' },
                    { id: "embedding", to: '/embedding-generator', icon: 'material-symbols:transform', text: 'Embedding generator' }
                ]
            },
