    ...
    <div class="d-flex flex-grow-1 flex-shrink-1 w-100">
      <div class="flex-column align-items-stretch position-relative w-100 flex-grow-1 flex-shrink-1 d-flex">
        ...
        <div class="flex-grow-1 flex-shrink-1 d-flex flex-column overflow-y-auto default-area">
          ...
          >
            <div class="flex-grow-1 flex-shrink-1 d-flex flex-column overflow-y-auto col-md-8 col-lg-9 h-100">
              <slot name="default" />
            </div>
            <div class="flex-shrink-0 secondary-sidebar border-start d-none d-md-flex flex-column overflow-y-auto col-md-4 col-lg-3 p-4 h-100">
