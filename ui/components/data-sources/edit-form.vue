    ...
    <div class="container">
        <BForm v-if="updateModel">
            <BFormGroup label="Name" label-for="dataSourceName" label-class="mb-1" class="mb-3">
                <BFormInput id="dataSourceName" v-model="updateModel.name" required placeholder="Enter data source name"
                    :state="nameValidation"></BFormInput>
            ...
            <BFormGroup label="Type" label-for="dataSourceType" label-class="mb-1" class="mb-3">
                <BFormSelect id="dataSourceType" v-model="updateModel.type" :options="dataSourceTypes" required
                    :state="typeValidation"></BFormSelect>
            ...
            <BFormGroup label="Description" label-for="dataSourceDesc" label-class="mb-1" class="mb-3">
                <BFormTextarea id="dataSourceDesc" v-model="updateModel.description"></BFormTextarea>
            </BFormGroup>

            <BFormGroup label="Connection string" label-for="dataSourceConnStr" label-class="mb-1" class="mb-3">
                <BFormInput id="dataSourceConnStr" v-model="updateModel.conn_str" required
